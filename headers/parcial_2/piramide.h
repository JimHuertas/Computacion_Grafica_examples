...
public:
    ...
    5. up
    */
    Piramide(std::vector<glm::vec4> newColor, glm::vec3 translacion, glm::vec3 escalar, glm::mat4 model_) {
...
;
        ...
        float vertices2[] = { ///azul
            -0.0f, -0.5f,  0.5f,  0.0f, 0.0f,
             0.5f, -0.5f,  -0.5f,  1.0f, 0.0f,
             0.5f,  0.5f,  0.5f,  1.0f, 1.0f,
            -0.0f,  0.5f,  0.0f,  0.0f, 1.0f,
        };
        float vertices3[] = { //verde
            -0.5f,  -0.5f,  -0.5f,  1.0f, 0.0f,
        ...
        lados[3].setColor(colores[3]); lados[3].setVertices(vertices5, indices);
